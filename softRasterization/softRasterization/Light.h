...
public:
	DirectionLight(const glm::vec3& pos = glm::vec3(3, 5, 10), const glm::vec3& color = glm::vec3(1.0), const glm::vec3& dir = glm::vec3(3, 5, 10), const float& intensity = 1.0f) :
		Light(pos, color, dir, intensity) {
		lightView = glm::lookAt(pos, glm::vec3(0.0f), glm::vec3(0, 1, 0));
		lightProj = glm::ortho(-5.0f, 5.0f, -5.0f, 5.0f,0.3f,20.0f);
	}
